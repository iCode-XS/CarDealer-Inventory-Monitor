...
* The features of this script aren't just limited to just access the information available from the website! You can also use this script to create an excel file or a csv file or even a database in theory if we want to. (Coming soon...)
